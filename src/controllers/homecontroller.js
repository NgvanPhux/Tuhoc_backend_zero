...
const { getALLusers, getuserbyid, deletebyid } = require('../services/CRUDservice')
...
module.exports = {
    getHomepage, getabcd, postCreateUser, getcreatepage, getupdatepage, postUpdateUser, postDeleteUser, postHandleremoveUser
}